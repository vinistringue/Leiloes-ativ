...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void btnVenderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVenderActionPerformed
        ...
        try {
            ...
            listarProdutos(); // Após a venda, atualiza a lista de produtos exibida na tabela
        } catch (NumberFormatException e) {
            System.err.println("Erro ao converter ID do produto para inteiro: " + e.getMessage());
        }
    ...
    private void btnVendasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnVendasActionPerformed
        ...
        this.setVisible(false); // Esconde a tela atual (listagemVIEW)
